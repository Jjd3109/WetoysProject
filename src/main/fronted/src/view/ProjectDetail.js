            ...
            <div className="grid place-items-center bg-white py-24 sm:py-32 grid-cols-10 ">
                ...
                <div className="m-auto px-4 py-8 max-w-xl ">
                    ...
                    <div className="max-w-lg mx-auto my-10 bg-white rounded-lg shadow-md p-5">
                        ...
                        <h2 className="text-center text-2xl font-semibold mt-3">{list[0].userName}</h2>
                        <p className="text-center text-gray-600 mt-1">{list[0].info}</p>
                        ...
                        <p className="text-gray-600 mt-2">{list[0].about}</p>
                        </div>
                    </div>
