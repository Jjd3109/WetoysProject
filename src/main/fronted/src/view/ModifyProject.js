        ...
        */
        axios.get(`/api/v1/project/${id}`)
            .then(function(res){
                ...
                if (res.data[0].requiredPositions.includes('백엔드')) {
                    setBackendChecked(true);
                }
                if (res.data[0].requiredPositions.includes('프론트엔드')) {
                    setFrontendChecked(true);
                }
                if (res.data[0].requiredPositions.includes('디자인')) {
                    setDesignChecked(true);
                }
                if (res.data[0].requiredPositions.includes('기획')) {
                    setPlanningChecked(true);
                }
                if (res.data[0].requiredPositions.includes('기타')) {
